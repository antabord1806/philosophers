...
<p>This project is a concurrency simulation based on the classic Dining Philosophers problem. The goal is to learn how to handle resourse sharing between threads, using mutexes to avoid <a href="#race-condition"><strong>race-conditions</strong></a>, deadlock or starvation which are just simptoms of missmanaged resources.</p>
